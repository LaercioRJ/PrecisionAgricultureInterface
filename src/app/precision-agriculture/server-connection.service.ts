  ...
  consumeKrigingInterpolation(modelk: string, nuggetE: number, methodk: string, rangek: number, partialSillk: number,
    ...
    return this.httpClient.post(url, {
        variogram: {
            estimator: 'classical',
            model: modelk,
            nuggetEffect: nuggetE,
            method: methodk,
            partialSill: partialSillk,
            range: rangek,
            kappa: 0.5,
            lambda: 1,
            autoLags: this.krigingAutoLags,
            amountLags: this.krigingAmoutLags,
            cutoff: this.krigingCutoff,
            pairs: this.krigingPairs
        },
        sizePixelX: sPixelX,
        sizePixelY: sPixelY,
        roundCoord: 5,
